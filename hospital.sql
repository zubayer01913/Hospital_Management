...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2015 at 05:07 AM
...
CREATE TABLE IF NOT EXISTS `patients` (
  ...
  `email` varchar(255) NOT NULL,
  `add_date` varchar(255) NOT NULL,
  `p_room_rent` int(10) DEFAULT NULL,
  `p_medecine_cost` int(10) DEFAULT NULL,
  `p_test_cost` int(10) DEFAULT NULL,
  `p_other_cost` int(10) DEFAULT NULL,
  `p_total` int(10) DEFAULT NULL,
...
INSERT INTO `patients` (`p_id`, `p_pic`, `p_username`, `p_name`, `p_password`, `age`, `sex`, `blood_group`, `type_of_disease`, `treating_doctor`, `room_no`, `contact`, `p_status`, `total_bill`, `address`, `email`, `add_date`, `p_room_rent`, `p_medecine_cost`, `p_test_cost`, `p_other_cost`, `p_total`, `release_date`) VALUES
(2, '01719022565.jpg', 'liton', 'Shahinur Rahman', 'e10adc3949ba59abbe56e057f20f883e', 26, 'Male', 'B+', 'Fever', 'Rashed', 302, '01719022565', 'Not good', '300/=', 'Dhaka', 'shahinur0077@gmail.com', '02-08-2015', 3242, 3454, 435435, 3454235, NULL, '2015-11-27'),
(3, '01720768768.jpg', 'jhasdghj', 'rimonddsfs', '25d55ad283aa400af464c76d713c07ad', 12, 'Male', '0-', 'fever', 'Dr. hassan', 0, '01720768768', 'on treatment', '300', 'dhaka', 'realmahmudulhasan@gmail.com', '12/6/1991', 1000, 500, 1000, 1000, NULL, '2015-11-13'),
(4, '01717117878.jpg', 'shariful1234', 'sharifu lislam', '25d55ad283aa400af464c76d713c07ad', 26, 'Male', 'A+', 'fever', 'Dr. rimon', 506, '01717117878', 'on treatment', '300', 'dhaka', 'rimon@gamil.com', '12-5-91', NULL, NULL, NULL, NULL, NULL, '0000-00-00'),
(5, '0172076876.jpg', 'zubayer1234', 'zubayer bin ayub', '25d55ad283aa400af464c76d713c07ad', 12, 'Male', '0-', 'fever', 'Dr. rimon', 123, '0172076876', 'on treatment', '300', 'dhaka', 'rks@hospital.com', '12-6-2915', NULL, NULL, NULL, NULL, NULL, '0000-00-00'),
(6, '01670685284.jpg', 'biplob1234', 'jahidul islam', '25d55ad283aa400af464c76d713c07ad', 28, 'Male', 'O-', 'diarrhoea', 'Dr. Shagor', 308, '01670685284', 'on treatment', '400', 'dhaka', 'email@gmail.com', '12-6-2014', NULL, NULL, NULL, NULL, NULL, '0000-00-00');
