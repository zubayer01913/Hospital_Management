...
if(isset($_POST['form1'])) {
	...
	try {
		...
		$statement = $db->prepare("INSERT INTO post (post_title,post_details,post_pic,c_name,post_date) VALUES (?,?,?,?,?)");
		$statement->execute(array($_POST['post_title'],$_POST['post_details'],$f1,$_POST['c_name'],$post_date));
...
<tr>
<td>
<textarea name="post_details" cols="30" rows="10"></textarea>
