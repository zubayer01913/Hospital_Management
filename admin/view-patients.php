...
<table class="tbl2" width="100%">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<tr>
			...
			&nbsp;|&nbsp;
			<a href="edit-patients.php?p_id=<?php echo $row['p_id']; ?>">Edit</a>
			&nbsp;|&nbsp;
			<a onclick='return confirmDelete();' href="view-patients.php?p_id=<?php echo $row['p_id']; ?>"><img src="../images/delete.gif"></a></td>
