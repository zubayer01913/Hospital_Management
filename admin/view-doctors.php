...
<table class="tbl2" width="100%">
	...
	{		
		...
		<tr>
			...
			&nbsp;|&nbsp;
			<a href="edit-doctors.php?doc_id=<?php echo $row['doc_id']; ?>">Edit</a>
			&nbsp;|&nbsp;
			<a onclick='return confirmDelete();' href="view-doctors.php?doc_id=<?php echo $row['doc_id']; ?>"><img src="../images/delete.gif"></a></td>
